    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                setDashboardData({
                    todaysTodos: [
                        { id: 1, text: 'UI/UX 디자인 컨셉 확정', completed: false, priority: 'HIGH', userId: 1, dueDate: '2025-08-18' },
                        { id: 2, text: '백엔드 API 명세서 작성', completed: true, priority: 'HIGH', userId: 1, dueDate: '2025-08-18' },
                        { id: 3, text: 'DB 스키마 디자인', completed: false, priority: 'MEDIUM', userId: 1, dueDate: '2025-08-18' },
                    ],
    ...
    return (
        ...
        <div className="dashboard-grid">
            ...
            <section className="main-stats">
                ...
                <StatCard title="오늘 끝낸 일" value={`${todaysCompletedCount} / ${todaysTotalCount}`} description={`${todaysProgress}% 달성`} />
            </section>
            <section className="todo-list-section">
                <h3>오늘의 프로젝트</h3>
                <TodoList todos={todaysTodos} onRemove={() => {}} onToggle={() => {}} />
            </section>
